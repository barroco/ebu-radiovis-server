...
import ebu.dev.radiovis.server.TopicHistory;
import ebu.dev.radiovis.server.TopicSubscriptions;
/*
...
public interface ITopicManager {
	TopicSubscriptions getSubscriptions();
	TopicHistory getHistory();
