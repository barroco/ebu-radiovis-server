...
import ebu.dev.radiovis.server.TopicHistoryItem;
/*
...
*/
public interface ITopicHistory {
	String add(String topic, String message); // Return new MessageID
	TopicHistoryItem getLastMessage(String topic);
}
