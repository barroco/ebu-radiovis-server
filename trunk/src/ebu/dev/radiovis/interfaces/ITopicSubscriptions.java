...
*/
import ebu.dev.radiovis.server.StompSession;

public interface ITopicSubscriptions {
	void subscribe(String topic, StompSession session);
	void unsubscribe(String topic, StompSession session);
